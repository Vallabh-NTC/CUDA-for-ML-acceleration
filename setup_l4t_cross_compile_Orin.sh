...
echo "=========================================="
echo "  L4T Cross-Compile Setup (t234ref)"
echo "=========================================="
...
# ============================================================
# 3) BUILD NVIDIA PUBLIC SOURCES (Orin AGX → t234ref)
# ============================================================

echo "[STEP 3] Building nv_public_src (t234ref)..."

export CROSS_COMPILE_AARCH64=$TOOLCHAIN_PREFIX
export CROSS_COMPILE_AARCH64_PATH=/l4t/toolchain
export NV_TARGET_BOARD=t234ref    # <<<<<< THIS IS THE ORIN BOARD ID
